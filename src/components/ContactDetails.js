                    ...
                    <div className='first-des'>
                        <div className='container-max'>
                            ...
                            <div className='right-adress'>
                                ...
                                <a href={`tel:${item.tel}`} className="contact-info__contact-copya1 stylesame-a">{item.tel}</a>
                                <p class="contact-info__contact-titlep2 stylesame-p">{item.text1}</p>
                                <a href={`mailto:${item.text2}`} className="contact-info__contact-copya1 stylesame-a">{item.text2}</a>
                            </div>
                            <div className='more-right-inner-right'>
                                <p class="contact-info__contact-titlep1 stylesame-p">{item.text3}</p>
                                <a href={`mailto:${item.text4}`} class="contact-info__contact-copya1 stylesame-a">{item.text4}</a>
                                <p class="contact-info__contact-titlep2 stylesame-p">{item.text5}</p>
                                <a href={`mailto:${item.text6}`} class="contact-info__contact-copya1 stylesame-a">{item.text6}</a>
                            </div>
                        </div>
                    </div>
                ))}
                ...
                {ContactDetails2.map((item, index) => (
                    <div className='second-des'>
                        <div className='container-max'>
                            ...
                            <div className='right-adress'>
                            <a href={item.AddressLink} className="contact-info__contact-copya1 stylesame-a">{item.AddressTitle}</a>
                            </div>
                            <div className='more-right-inner-right'>
